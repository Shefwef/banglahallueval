...
Usage:
    python "Reasoning/Evaluation Script/Evaluation Script for hallucinated 1000/evaluate_reasoning_mistral_llama.py"
"""
...
MODELS = [
    ("mistral-nemo:latest", "reasoning_evaluation_scored_mistral_nemo.csv"),
    ("llama3.1:8b",         "reasoning_evaluation_scored_llama3_1_8b.csv"),
]
...
def extract_label(raw: str) -> str:
    """Parse Yes/No from raw model response, handling JSON and plain text."""
    ...
    # fallback: plain yes/no anywhere in response
    lower = raw.lower()
    if "yes" in lower:
        return "Yes"
    if "no" in lower:
